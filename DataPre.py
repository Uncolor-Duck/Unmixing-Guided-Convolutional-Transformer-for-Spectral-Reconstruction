...
parser.add_argument("--data_path", type=str, default='/home/data/duanshiyao/Unmixing/PDASS_Data/New/', help="data path")
...
parser.add_argument("--train_data_path", type=str, default='/home/data/duanshiyao/Unmixing/PDASS/New/', help="preprocess_data_path")
